...
def analysis_group_ret(
 ...
    ----------
    ...
    weight_name = "Euqal" if mktmv_df is None else "Euqal"
    # 分组净值曲线
    ...
    plot_params_dct1 = {
        ...
        "xlabel": "Date",
        "ylabel": "Net value",
        "fig_title": f"{factor_name}Group net worth curve({weight_name})",
    }
    ...
    plot_params_dct2 = {
        ...
        "label1": "Factor long/short yield(%)",
        "label2": "Factor cumulative long-short yield(%)",
        "xlabel": "Date",
        "ylabel1": "Factor long/short yield(%)",
        "ylabel2": "Factor cumulative long-short yield(%)",
        "fig_title": f"{factor_name}yield({weight_name})",
    }
