...
# 根据数据频率映射到相应的年化因子
mapping_dct = {"DAILY": 252, "WEEKLY": 52, "MONTHLY": 12, "Q": 4}
...
def annualized_return(returns, period="Q"):
    """
    Description
    ----------
...
def annualized_volatility(returns, period="Q"):
    """
    Description
    ----------
...
def annualized_sharpe(returns, rf=0, period="Q"):
    """
    Description
    ----------
...
def er_annual_return(returns, benchmark_returns, period="Q"):
    """
    Description
    ----------
...
def er_annual_volatility(returns, benchmark_returns, period="Q"):
    """
    Description
    ----------
    计算超额收益的年化波动率
...
def information_ratio(returns, benchmark_returns, period="Q"):
    """
    Description
    ----------
...
# 总结输出模块
def get_backtest_result(returns, rf=0, benchmark_returns=None, period="Q"):
    """
    Description
    ----------
